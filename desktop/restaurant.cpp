...
void Restaurant::addTable(QString name){
	tableList.addTable(name);
}

void Restaurant::deleteTable(QString name){
	tableList.deleteTable(name);
}

void Restaurant::addProduct(QString name, float price){
	productList.addProduct(name, price);
}

void Restaurant::deleteProduct(QString name){
